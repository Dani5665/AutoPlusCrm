        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainDiscountId = table.Column<int>(type: "int", nullable: true),
                    CreditLimitId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VisitPurpose = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true, comment: "Purpose of the visit"),
                    CustomerComments = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true, comment: "Any information that came from the client. It can be about our products, competitors, his impressions..."),
                    TakenActions = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true, comment: "Actions taken from the visitor so that the client starts using our services and products "),
                    DateOfVisit = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date when the visit happened"),
                    VisitGradeId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ClientId = table.Column<int>(type: "int", nullable: false, comment: "Id of the client"),
                    SupplierStore = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "The name of the supplier store"),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "The city of the visited location"),
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "The region of the visited location"),
                    ClientTypeId = table.Column<int>(type: "int", nullable: true, comment: "Client type id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitId1 = table.Column<int>(type: "int", nullable: false, comment: "Id of the visit")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitClassId = table.Column<int>(type: "int", nullable: false, comment: "Id of the visit")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitGrades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitGrades_Visits_VisitClassId",
                        column: x => x.VisitClassId,
                        principalTable: "Visits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
